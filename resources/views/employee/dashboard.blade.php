								...
								<div class="col-md-6">
									<div class="row">
										...
										<div class="col-md-2 mt-4">
											<a href="JavaScript:void(0)" class="btn btn-outline-primary form-control filterBtn"
												data-route={{ route('dataFilter') }}>Filter</a>
								...
								<tbody>
									...
									@forelse ($employee_attendences as $attendence)
										<tr>
											...
											<td>{{ Carbon\Carbon::parse($attendence->attendence_date)->format('d F') }}</td>
											<td>{{ $attendence->attendence_time }}</td>
											<td>{{ $attendence->in_time }}</td>
											<td>{{ $attendence->out_time }}</td>
											<td>
												<button data-id="{{ $attendence->id }}" class="btn btn-primary mb-2 ml-2 edit-attendence" data-toggle="modal"
													data-target="#employeeEditAttendenceModal" title="Edit"><i class="nav-icon i-Pen-4"></i></button>
						...
						<form>
							<div class="row">
								...
								<div class="col-md-6 form-group mb-3">
									...
									<input type="text" class="form-control" id="attendence_time" name="attendence_time" value="9:00 AM" readonly>
								</div>
								<div class="col-md-6 form-group mb-3">
								...
								<div class="col-md-6 form-group mb-3">
									...
									<input type="time" class="form-control" id="out_time" name="out_time" placeholder="Enter attendence time">
									{{-- <span class="text-danger" id="fullnameError"></span> --}}
								</div>
					...
					<div class="modal-body">
						<form>
							...
							<div class="row">
								...
								<div class="col-md-6 form-group mb-3">
									<label for="attendence_time">Attendence Time</label>
									<input type="text" class="form-control" id="edit_attendence_time" name="attendence_time" value="9:00 AM"
										readonly>
								</div>
								<div class="col-md-6 form-group mb-3">
									<label for="in_time">In Time</label>
