                            ...
                            <form method="POST" action="{{ route('store.employee.detail') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-4 text-center">
                                        <img src="{{ asset('backend/assets/image.png') }}" id="showImage" class="card-img-top rounded-circle overflow-hidden" alt="image" style="width: 6rem; height:6rem">
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" id="birthday" name="birthday" class="form-control" placeholder="yyyy-mm-dd">
                                        @error('birthday')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="permanent_address" name="permanent_address" placeholder="Enter parmanent address">
