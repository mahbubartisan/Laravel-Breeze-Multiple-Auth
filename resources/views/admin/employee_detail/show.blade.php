						...
						<table class="display table table-striped table-bordered table-responsive{-sm|-md|-lg|-xl}"
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="{{ url('employee-details/' . $employee_detail->id . '/edit/') }}"
											class="btn btn-primary mb-2 ml-2" title="Edit"><i
												class="nav-icon i-Pen-4"></i></a>
										<a href="{{ url('employee-details/' . $employee_detail->id . '/delete/') }}"
											class="btn btn-danger mb-2 ml-2" title="Delete"><i
