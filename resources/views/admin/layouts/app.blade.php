...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/styles/vendor/perfect-scrollbar.css') }}">
</head>
...
<body>
            ...
            <div class="header-part-right">
                ...
                <div class="dropdown">
                    <div class="user col align-self-end">
                        <img src="{{ asset('frontend/assets/images/faces/1.jpg') }}" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="search-ui">
        <div class="search-header">
            <img src="{{ asset('frontend/assets/images/logo.png') }}" alt="" class="logo">
        ...
        <div class="search-results list-horizontal">
            <div class="list-item col-md-12 p-0">
                <div class="card o-hidden flex-row mb-4 d-flex">
                    <div class="list-thumb d-flex">
                        <!-- TUMBNAIL -->
                        <img src="{{ asset('frontend/assets/images/products/headphone-1.jpg') }}" alt="">
                    </div>
            ...
            <div class="list-item col-md-12 p-0">
                <div class="card o-hidden flex-row mb-4 d-flex">
                    <div class="list-thumb d-flex">
                        <!-- TUMBNAIL -->
                        <img src="{{ asset('frontend/assets/images/products/headphone-2.jpg') }}" alt="">
                    </div>
                    <div class="flex-grow-1 pl-2 d-flex">
                        <div class="card-body align-self-center d-flex flex-column justify-content-between align-items-lg-center flex-lg-row">
                            <!-- OTHER DATA -->
            ...
            <div class="list-item col-md-12 p-0">
                <div class="card o-hidden flex-row mb-4 d-flex">
                    <div class="list-thumb d-flex">
                        <!-- TUMBNAIL -->
                        <img src="{{ asset('frontend/assets/images/products/headphone-3.jpg') }}" alt="">
                    </div>
                    <div class="flex-grow-1 pl-2 d-flex">
                        <div class="card-body align-self-center d-flex flex-column justify-content-between align-items-lg-center flex-lg-row">
                            <!-- OTHER DATA -->
            ...
            <div class="list-item col-md-12 p-0">
                <div class="card o-hidden flex-row mb-4 d-flex">
                    <div class="list-thumb d-flex">
                        <!-- TUMBNAIL -->
                        <img src="{{ asset('frontend/assets/images/products/headphone-4.jpg') }}" alt="">
                    </div>
                    <div class="flex-grow-1 pl-2 d-flex">
                        <div class="card-body align-self-center d-flex flex-column justify-content-between align-items-lg-center flex-lg-row">
                            <!-- OTHER DATA -->
    ...
    <script src="{{ asset('frontend/assets/js/vendor/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/vendor/echarts.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/es5/echart.options.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/es5/dashboard.v1.script.min.js') }}"></script>
