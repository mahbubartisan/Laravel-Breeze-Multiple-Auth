...
<div class="main-content">
	...
	<div class="row mb-4">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<button data-toggle="modal" data-target="#employeeModal"
						class="btn btn-md btn-outline-primary ripple m-3" style="float:right"><i class="fa fa-plus"> Add
							Employee</i></button>
								...
								<tr>
									...
									<td>
										<button data-id="{{ $employee->id }}"
											class="btn btn-primary mb-2 ml-2 edit-employee" data-toggle="modal"
											data-target="#employeeEditModal" title="Edit"><i
												class="nav-icon i-Pen-4"></i></button>
										<button data-id="{{ $employee->id }}"
											class="btn btn-danger mb-2 ml-2 btn-delete" title="Delete"><i
				...
				<div class="modal-body">
					<form>
						...
						<div class="row">
							...
							<div class="col-md-6 form-group mb-3">
								<label for="email">Email address</label>
								<input type="email" class="form-control email" id="edit_email" name="email"
									placeholder="Enter email">
